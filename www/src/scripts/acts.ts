...
export let list: Act[] = [
	...
	},
	{
		...
		session: [
			...
			{ kind: 'warn', text: 'body-drift         1', step: 'drift', hold: 1400 },
	...
	},
	{
		...
		session: [
			...
			{ kind: 'out', text: 'fix-login  dirty  1 pending note(s)' },
	...
	},
	{
		...
		session: [
			...
			{ kind: 'out', text: '  7 fresh, 1 body-drift' },
			{ kind: 'out', text: '  0 signature-changed, 0 anchor-missing' },
			{ kind: 'out', text: '  reviewed 1 drift via anthropic(haiku)' },
			{ kind: 'hi', text: '  superseded  src/auth.rs#fn verify' },
